...
#Fis scatterplot
Fis_plot <- ggplot(data = tot_div_sum, aes(x = Pop, y = Fis_mean, col=X)) geom_point() + geom_errorbar(aes(ymin = Fis_mean - Fis_sterror, ymax = Fis_mean + Fis_sterror), width= .2, position=position_dodge(.9))
Fis_plot

Fis_plot <- ggplot(data = tot_div_sum, aes(x = Pop, y = Fis_mean, col=X), position=position_dodge()) + geom_errorbar(aes(ymin = Fis_mean - Fis_sterror, ymax = Fis_mean + Fis_sterror), width= .2, position=position_dodge(.9)) + geom_point()
Fis_plot
